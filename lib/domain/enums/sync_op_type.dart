...
enum SyncOpType {
  ...
  privilegeCreate('privilege_create'),
  privilegeFieldUpdate('privilege_field_update'),
  privilegeRedemptionCreate('privilege_redemption_create'),
  privilegeRedemptionFieldUpdate('privilege_redemption_field_update'),
